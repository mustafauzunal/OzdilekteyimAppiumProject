    ...
    public void beforeScenario() throws MalformedURLException {
        ...
        if (StringUtils.isEmpty(System.getenv("key"))) {
            ...
            if (System.getenv("platform").equals("ANDROID")) {
                ...
                capabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE,"com.mobisoft.boyner");
                capabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, "com.mobisoft.boyner.activity.MainActivity");
